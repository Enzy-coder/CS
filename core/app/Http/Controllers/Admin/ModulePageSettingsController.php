...
class ModulePageSettingsController extends Controller
{
    ...
    public function storeProductDetailPage(Request $request)
    {
        $all_field_rules = [
            ...
            'sidebar_position' => 'nullable|string',
            'product_sku_show_hide' => 'nullable|string',
        ];
        $this->validateAndInsert($request, $all_field_rules);
    ...
    public function productSettingsPage()
    {
        return view('backend.settings.product-settings-page');
    }

    public function storeProductSettingsPage(Request $request)
    {
        $all_field_rules = [
            'product_in_stock_limit_set' => 'nullable|string',
        ];
        $this->validateAndInsert($request, $all_field_rules);
