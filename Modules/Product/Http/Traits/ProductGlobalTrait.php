...
trait ProductGlobalTrait
{
    ...
    public function productUpdate($data, $id): bool
    {
        ...
        $prod_category = $this->productCategoryData($data, $id);
        $prod_category['country_id'] = $data['country_id'] ?? null;
        ProductCategory::updateOrCreate(["product_id" => $id], $prod_category);
...
//                'general_title' => $product?->metaData?->meta_tags,
    ...
    private function product_relational_data_insert(array $data, $id, $product): bool
    {
        ...
        $prod_category = $this->productCategoryData($product, $id);
        $prod_category['country_id'] = $product['country_id'] ?? null;
        ProductCategory::create($prod_category);
        // this condition will make sub category optional
