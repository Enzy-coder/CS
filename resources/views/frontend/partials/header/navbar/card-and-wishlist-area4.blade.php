    ...
    <div class="login-account">
        @if (auth('web')->check())
            <a class="accounts" href="#1">
                <span class="icon-title logged-in">{{ auth('web')->user()->name }}</span>
            </a>
        ...
        @else
            ...
            <ul class="account-list-item">
                <li class="list text-end"> <a href="{{ route('user.login') }}">
                        {{ __('Sign In') }} </a> </li>
                <li class="list text-end"> <a href="{{ route('user.register') }}">
                        {{ __('Sign Up') }} </a> </li>
            </ul>
        @endif
    </div>
