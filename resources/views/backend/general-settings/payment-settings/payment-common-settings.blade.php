...
<div class="form-group">
    <label for="enable_disable_decimal_point">{{__('Enable/Disable Decimal Point')}}</label>
...
<div class="form-group">
    <label for="add_remove_sapce_between_amount_and_symbol">{{__('Add/Remove Space Between Currency Symbol and Amount')}}</label>
